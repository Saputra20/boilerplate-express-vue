...
| Depends On | be/15-bullmq-foundation, be/07-security-foundation |
...
QUEUE_MONITOR_USERNAME and QUEUE_MONITOR_PASSWORD: required, non-empty, secret, no default.
...
- [ ] Queue Monitor capability exists at documented boundary.
...
| --- | --- | --- |
| `docs/ARCHITECTURE.md` | repository and layer boundaries | Queue Monitor boundary |
| `docs/SECURITY.md` | relevant baseline | security/UI constraints |
| Existing task directory | `be/16-queue-monitor` | task identity/order |
