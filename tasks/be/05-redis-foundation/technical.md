...
| Field | Value |
| --- | --- |
| Task ID | `be/05-redis-foundation` |
...
| Blocks | be/06-logging-foundation |
| Execution Order | 5 |
...
REDIS_HOST, REDIS_PORT, REDIS_USERNAME, REDIS_PASSWORD, REDIS_DATABASE, REDIS_TLS: use documented separated configuration; no implicit defaults; password secret.
...
- [ ] Redis Foundation capability exists at documented boundary.
...
| --- | --- | --- |
| `docs/ARCHITECTURE.md` | repository and layer boundaries | Redis Foundation boundary |
| `docs/SECURITY.md` | relevant baseline | security/UI constraints |
| Existing task directory | `be/05-redis-foundation` | task identity/order |
