...
| Depends On | be/07-security-foundation |
...
No business endpoint. Add document generation/registration convention; documentation path/access policy unresolved.
...
- [ ] OpenAPI Infrastructure capability exists at documented boundary.
...
| --- | --- | --- |
| `docs/ARCHITECTURE.md` | repository and layer boundaries | OpenAPI Infrastructure boundary |
| `docs/SECURITY.md` | relevant baseline | security/UI constraints |
| Existing task directory | `be/17-openapi` | task identity/order |
