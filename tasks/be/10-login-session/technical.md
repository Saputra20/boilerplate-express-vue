...
| Depends On | be/04-identity-schema, be/08-jwt-foundation, be/09-password-hashing |
...
- [ ] Login And Session capability exists at documented boundary.
...
| --- | --- | --- |
| `docs/ARCHITECTURE.md` | repository and layer boundaries | Login And Session boundary |
| `docs/SECURITY.md` | relevant baseline | security/UI constraints |
| Existing task directory | `be/10-login-session` | task identity/order |
