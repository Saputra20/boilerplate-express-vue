# be/01-initial-project — Initial Project

## 1. Metadata

| Field | Value |
| --- | --- |
| Task ID | `be/01-initial-project` |
...
| Depends On | None. |
| Blocks | be/02-environment-validation |
| Execution Order | 1 |
...
Create/Modify: Inspect/modify `apps/api/package.json`, `apps/api/tsconfig.json`, `apps/api/src/`, `apps/api/tests/`, root compose/gitignore.
...
- [ ] Initial Project capability exists at documented boundary.
...
| --- | --- | --- |
| `docs/ARCHITECTURE.md` | repository and layer boundaries | Initial Project boundary |
| `docs/SECURITY.md` | relevant baseline | security/UI constraints |
| Existing task directory | `be/01-initial-project` | task identity/order |
