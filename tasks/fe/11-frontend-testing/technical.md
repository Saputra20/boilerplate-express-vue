...
- [ ] Frontend Testing Foundation capability exists at documented boundary.
...
| --- | --- | --- |
| `docs/ARCHITECTURE.md` | repository and layer boundaries | Frontend Testing Foundation boundary |
| `docs/DESIGN.md` | relevant baseline | security/UI constraints |
| Existing task directory | `fe/11-frontend-testing` | task identity/order |
