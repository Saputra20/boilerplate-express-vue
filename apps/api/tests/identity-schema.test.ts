...
import { permissions, rolePermissions, roles, userRoles, users, userStatus } from '../src/database/schema.js';
...
describe('identity schema', () => {
  it('defines only approved identity tables and user states', () => {
    ...
    expect(tableColumns(roles)).toEqual(['id', 'code', 'name', 'description', 'createdAt', 'updatedAt']);
    expect(tableColumns(permissions)).toEqual(['id', 'code', 'description', 'createdAt', 'updatedAt']);
