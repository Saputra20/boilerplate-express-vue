---
name: banner-design
description: "Design banners for social media, ads, website heroes, creative assets, and print. Explicit creative skill with optional unavailable external dependencies documented below."
...
Design banners across social, ads, web, and print formats. Generates multiple art direction options per request with AI-powered visual elements. This skill handles banner design only and activates on explicit creative requests. It does NOT handle normal application UI, video editing, full website design, or print production.
